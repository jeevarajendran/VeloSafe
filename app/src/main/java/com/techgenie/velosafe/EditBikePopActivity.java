...
/**
 * Class Name : EditBikePopActivity
 * Purpose : The purpose of this activity is editbike the details.If the user want to edit ,he/she can
 * edit and it will shows the saved.The data will be saved in the sqlite
 */
public class EditBikePopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_bike_details_save.setOnClickListener(new View.OnClickListener() {
            ...
            /**
             * Method : onClick
             * Purpose: When user click on edit button the details will update in sqlite
             * */
            ...
            public void onClick(View v) {
                ...
                System.out.println("Updated"+myDB.updateBikeData(editedBikeMake, editedBikeModel,
                        editedBikeFrame, editedBikeColor));
